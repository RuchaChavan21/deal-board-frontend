          ...
          <div className="px-4 py-4 border-b border-[#25304a]">
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-xs font-medium text-gray-300 uppercase tracking-wide">CRM Teamspace</span>
      ...
      <aside className="w-64 bg-[#1a233a] flex flex-col shadow-lg">
        ...
        <div className="px-4 py-4 border-b border-[#25304a]">
          ...
          >
            ...
            <ChevronDown
              className={`w-4 h-4 text-gray-400 transition-transform ${isTeamspaceOpen ? "rotate-180" : ""}`}
            />
          </button>
        </div>
